...
% 	Given a batch of $B$ UVL Scenes $s_{1\dots B}$ with $L$ different label values, we project $L$ different neural textures $\tau_{1\dots L}$ onto that scene; obtaining projections $\pi_{1\dots B}$. This projection mechanism is illustrated in figure \ref{fig:uvl_explanation}.
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=25x0pt]{../images/texture_realism_ablation.pdf}
	\end{center}
	\caption{
