...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=200pt]{dataset_explanation.pdf}
	\end{center}
	\caption{
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=400pt]{main_diagram_condensed.pdf}
	\end{center}
	\caption{
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=400pt]{unprojection_consistency_loss.pdf}
	\end{center}
	\caption{
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=400pt]{frame_inconsistency_diagram.pdf}
	\end{center}
