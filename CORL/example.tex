...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{
        \begin{tabular}{l|llllllll}
                                      ...
                                      & \multicolumn{2}{c|}{LPIPS}                                    & \multicolumn{2}{c|}{L2}                                         & \multicolumn{2}{c|}{LPIPS}                                  & \multicolumn{2}{c}{L2}                                        \\
        ...
        TRITON                        & \textbf{0.0286}               & \textbf{0.0267}               & \textbf{0.00479}               & \textbf{0.00478}               & \textbf{0.117}               & \textbf{0.1157}              & \textbf{0.0123}               & \textbf{0.0122}               \\
...
\begin{figure}[thbp]
    ...
    \vspace{-20pt}
    \caption{Sim2real framework of using TRITON. }
