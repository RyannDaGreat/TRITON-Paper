...
\label{sec:method}
	...
	\subsection{Neural Neural Texture Projection}
		...
		Given a two-dimensional $(u,v)$ vector, the spatial frequencies are used to generate a high dimensional embedding of $(u,v)$ as input for $M_i$, where $M_i$ is a function $\real^{256} \to \real^{3}$ mapping that embedding to an $(r,g,b)$ color value:
		\begin{equation}
				\psi_i(u,v) = 
				\
				% M_i(
