...
\section{Appendix} 
\subsection{Videos for Qualitative Evaluation}

	We have created animations using TRITON to see how consistency helps:

	\url{https://youtu.be/fuTSta_M6NQ}
...
\subsection{Training Procedures}
	...
	In this section we detail the training procedures used to create results in Section \ref{sec:results} from TRITON, CycleGAN, CUT,
		TRITON w/o $\lUC$ (i.e., TRITON with neither unprojection consistency loss nor texture reality loss), and
		TRITON w/o $\psi, \lUC$ (i.e., TRITON without textures, and therefore also without unprojection consistency loss or texture reality loss).
...
\subsection{More Results}
	...
	\subsubsection{Unprojection Comparisons}
		...
		Here, we expand on the results in Subsection \ref{sec:datasetsresults} by showing the mean unprojection for different image translation algorithms (Figure \ref{fig:unprojection_comparisons}). With the 14 UVL images and corresponding fake photos (or photos) as calculated in Section \ref{sec:datasetsresults}, we average their unprojections.
		...
		\begin{figure}[H]
			...
			\label{fig:unprojection_comparisons}
		\end{figure}
