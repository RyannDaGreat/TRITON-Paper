	...
	\subsubsection{Videos}
		...
		\begin{figure}[H]
			...
			\href{https://youtu.be/kecK_cJgLT8}{
					\includegraphics[width=400pt]{../images/robot_arm_animation_thumbnail.png}
					}
				\end{center}
			\caption{
		...
		\begin{figure}[H]
			\begin{center}
			\href{https://youtu.be/-GSixT4shxY}{
					\includegraphics[width=400pt]{../images/algo_comparison_thumbnail.pdf}
					}
				\end{center}
			\caption{
