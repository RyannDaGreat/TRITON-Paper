...
\title{TRITON: Learning to Recover Textures through Image Translation}
...
\begin{abstract}
	Unpaired image translation algorithms can be used for sim-to-real tasks, but they often fail to generate temporally consistent results.
	...
	We call this algorithm TRITON (Texture Recovering Image Translation Network): an unsupervised, end-to-end, stateless sim-to-real algorithm. [[Too many adjectives?]]
	...
	By settling on particular albedos for scene objects, we ensure consistency between frames statelessly. [[ie. no need for optical flow]]
	In addition, we introduce a translation consistency loss that further improves the consistency of the results. [[I called this “view consistency loss” in the code and to you, but translation consistency loss might be a better name? What do you think?]]
...
Authors are required to use the NeurIPS \LaTeX{} style files obtainaㅋble at the
